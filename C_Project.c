...
int main()
{
    ...
    printf("\t\t\t\t     SS\n");
    printf("\t\t\t\t      SS\n");
    printf("\t\t\t\t        SS           MMM          MMM        AA         RRRRRRRRRR  TTTTTTTTTTTTTTTTT\n");
    printf("\t\t\t\t          SS         MMMM        MMMM       AAAA        RR      RR  TTTTTTTTTTTTTTTTT\n");
    printf("\t\t\t\t            SS       MM MMMM   MMM MM      AA  AA       RR      RR         TT\n");
    printf("\t\t\t\t              SS     MM     MM     MM     AA    AA      RRRRRRRRRR         TT\n");
    printf("\t\t\t\t               SS    MM            MM    AAAAAAAAAA     RRRRRRRRRR         TT\n");
    printf("\t\t\t\t       S        SS   MM            MM   AA        AA    RR    RR           TT\n");
    printf("\t\t\t\t       SS     SS     MM            MM  AA          AA   RR     RR          TT\n");
    printf("\t\t\t\t         SSSSS       MM            MM AA            AA  RR      RR         TT");


    printf("\n\n");
    printf("\t\t\t\t\tTTTTTTTTTTTTTTTTT RRRRRRRRRR         AA  VV            VV  EEEEEEEEEEEE LL\n");
    printf("\t\t\t\t\tTTTTTTTTTTTTTTTTT RR      RR        AAAA  VV          VV   EE           LL\n");
    printf("\t\t\t\t\t       TT         RR      RR       AA  AA  VV        VV    EE           LL\n");
    printf("\t\t\t\t\t       TT         RRRRRRRRRR      AA    AA  VV      VV     EE           LL\n");
    printf("\t\t\t\t\t       TT         RRRRRRRRRR     AAAAAAAAAA  VV    VV      EEEEEEE      LL\n");
    printf("\t\t\t\t\t       TT         RR    RR      AA        AA  VV  VV       EE           LL\n");
    printf("\t\t\t\t\t       TT         RR     RR    AA          AA  VVVV        EE           LLLLLLLLLLLL\n");
    printf("\t\t\t\t\t       TT         RR      RR  AA            AA  VV         EEEEEEEEEEEE LLLLLLLLLLLL\n");
    printf("\n");
    printf("\t\t\t\t\t\t\t  GGGGG  UU      UU  IIIIIIIIIIII DDDDDDDD     EEEEEEEEEEEE  \n");
    printf("\t\t\t\t\t\t\tGG       UU      UU       II      DD     DD    EE   \n");
    printf("\t\t\t\t\t\t\tGG       UU      UU       II      DD      DD   EE   \n");
    printf("\t\t\t\t\t\t\tGG       UU      UU       II      DD       DD  EE   \n");
    printf("\t\t\t\t\t\t\tGG   GGG UU      UU       II      DD       DD  EEEEEE  \n");
    printf("\t\t\t\t\t\t\tGG     G  UU    UU        II      DD      DD   EE \n");
    printf("\t\t\t\t\t\t\tGG     G   UU  UU         II      DD     DD    EE \n");
    printf("\t\t\t\t\t\t\tGGGGGGGG    UUUU     IIIIIIIIIIII DDDDDDDD     EEEEEEEEEEEE\n\n");
